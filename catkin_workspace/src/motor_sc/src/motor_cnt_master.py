...
port1 = serial.Serial("/dev/ttyUSB1", baudrate=115200)
port2 = serial.Serial("/dev/ttyUSB2", baudrate=115200)
port3 = serial.Serial("/dev/ttyUSB3", baudrate=115200)
...
def callback(data):
      ...
      port0.write('\n')
      port1.write(data.cnt_data0[0])
      port1.write(data.cnt_data0[1])
      port1.write('\n')
      port2.write(data.cnt_data0[0])
      port2.write(data.cnt_data0[1])
      port2.write('\n')
      port3.write(data.cnt_data0[0])
      port3.write(data.cnt_data0[1])
      port3.write('\n')
      tmp=port0.readline()
